# -*- coding: utf-8 -*-
#
# PySpeak documentation build configuration file, created by
...
latex_documents = [
  ('index', 'PySpeak.tex', u'TEMPLATE Documentation',
   u'John Wyles', 'manual'),
]
...
man_pages = [
    ('index', 'pyspeak', u'PySpeak Documentation',
     [u'John Wyles'], 1)
]
