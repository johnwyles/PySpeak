...
class Listener():
    def __init__(self, filename_prefix='pyspeak_file', silence_time=2, threshold=60, language='en-US', max_results=4, bits=pyaudio.paInt16, channels=1, rate=44100, chunk=1024):
    ...
    def start(self):
        ...
        sliding_window = collections.deque(maxlen=self.silence_time*rel)
        started = False
